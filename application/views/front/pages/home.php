...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
   <div class="carousel-inner" style="background-image : url(<?= base_url("assets/images/carousel-bg.png") ?>">
      <?php $no = 0;?>
...
<section class="choice_area mt-4">
   ...
   <div class="row">
				<div class="col">
					<h2 class="section_title text-center">Event Yang Akan Datang</h2>
				</div>
			</div>
         <div class="row courses_row">
				...
				<div class="col-lg-4 course_col">
					<div class="course">
						<div class="course_image"><img class="img-fluid choice" src="<?= base_url("images/posting/small/$c->photo") ?>" alt=""></div>
                  	...
                  	<div class="course_info">
								<ul>
									<li>
										<a href="<?= base_url("blog/read/$c->seo_title") ?>"><h4><?= $c->title ?></h4></a>
...
<div class="instructors">
		<div class="instructors_background" style="background-image:url(<?= base_url('assets/images/instructors_background.png')?>)"></div>
		<div class="container">
			<div class="row">
				<div class="col">
					<h2 class="section_title text-center">Bidang Pengurus Harian</h2>
				</div>
			</div>
			<div class="row instructors_row">
				...
				<div class="col-lg-4 instructor_col">
					<div class="instructor text-center">
						<div class="instructor_image_container">
							<div class="instructor_image"><img src="<?= base_url('assets/images/instructor_1.jpg')?>" alt=""></div>
						</div>
						<div class="instructor_name"><a href="instructors.html">Sarah Parker</a></div>
						<div class="instructor_title">Ketua Umum</div>
				...
				<div class="col-lg-4 instructor_col">
					<div class="instructor text-center">
						<div class="instructor_image_container">
							<div class="instructor_image"><img src="<?= base_url('assets/images/instructor_2.jpg')?>" alt=""></div>
						</div>
						<div class="instructor_name"><a href="instructors.html">Sarah Parker</a></div>
						<div class="instructor_title">Sekretaris Umum</div>
						<div class="instructor_text">
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce enim nulla, mollis eu metus in, sagittis fringilla tortor.</p>
						</div>
						<div class="instructor_social">
				...
				<div class="col-lg-4 instructor_col">
					<div class="instructor text-center">
						<div class="instructor_image_container">
							<div class="instructor_image"><img src="<?= base_url('assets/images/instructor_3.jpg')?>" alt=""></div>
						</div>
						<div class="instructor_name"><a href="instructors.html">Sarah Parker</a></div>
						<div class="instructor_title">Bendahara Umum</div>
						<div class="instructor_text">
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce enim nulla, mollis eu metus in, sagittis fringilla tortor.</p>
						</div>
						<div class="instructor_social">
